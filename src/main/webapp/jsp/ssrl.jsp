...
<div id="div1">
  <div>
    <div style="float: left;">
      <a class="btn-primary"
         href="${pageContext.request.contextPath}/dormitoryinfo/toAdd">新增信息</a>
    </div>
  ...
  <table>
    ...
    <c:forEach var="dormitoryinfo" items="${requestScope.get('List')}" >
      <tr>
        ...
        <td><a href="${pageContext.request.contextPath}/dormitoryinfo/modifyview?id=${dormitoryinfo.id}">修改</a></td>
        <td><a href="${pageContext.request.contextPath}/dormitoryinfo/delete?id=${dormitoryinfo.id}" onclick="deleteById()">删除</a></td>
      </tr>
    </c:forEach>
