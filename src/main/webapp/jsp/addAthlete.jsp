...
<body>
<form action="${pageContext.request.contextPath}/athlete/addAthlete" method="post">
    <h2>添加运动员信息</h2>
    ...
    <p><span style="margin-right: 10px;">院系编号:</span>
        <input id="department_id" name="department_id"   type="text" class="textinput" placeholder="请输入比赛项目" />
    </p>
    <p>
