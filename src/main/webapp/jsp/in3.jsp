    ...
    <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
      <el-menu
        ...
        <el-submenu index="2">
          ...
          <el-menu-item-group>
            <el-menu-item index="2-1"  onclick="change3()">宿舍信息查看</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
        <el-submenu index="3">
          <template slot="title"><i class="el-icon-setting"></i>日常信息管理</template>
          <el-menu-item-group>
            <el-menu-item index="3-1" onclick="change2()">报修信息</el-menu-item>
          </el-menu-item-group>
...
<script type="text/javascript">
  ...
  function change2() {
    var objs=document.querySelector("#son");
    objs.src="${pageContext.request.contextPath}/dormrepair/list1";
  }
  function change3() {
    var objs=document.querySelector("#son");
    objs.src="${pageContext.request.contextPath}/dormitoryinfo/list3";
